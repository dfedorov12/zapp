...
const TOUR_STEPS = [
  { center: true, title: 'Willkommen bei ZAPP 👋',
    text: 'In wenigen Klicks meldest du eine Zuwendung (ein erhaltenes oder gegebenes Geschenk, eine Einladung, eine Bewirtung …). Dieses kurze Tutorial zeigt dir, wie – in unter einer Minute.' },
  { sel: '#fRichtung', title: '1) Richtung & Art',
    text: 'Zuerst: Hast du die Zuwendung <b>erhalten</b> oder <b>gegeben</b>? Und um welche <b>Art</b> handelt es sich (Geschenk, Bewirtung, Einladung …)?' },
  { sel: '#fBetrag', title: '2) Wert & Datum',
    text: 'Trage den <b>Wert in Euro</b> ein (ruhig geschätzt) und das <b>Datum</b> der Zuwendung.' },
  { sel: '#fPartner', title: '3) Geschäftspartner',
    text: 'Wer ist der Geschäftspartner? Bereits erfasste Partner werden vorgeschlagen – bitte denselben Namen verwenden. Das ist wichtig für die Jahressumme (<b>Kumulierung</b>).' },
  ...
  { sel: '#bewertung', title: 'Sofort-Bewertung (Ampel)', onEnter: _tourDemoBanner,
    text: 'Während du ausfüllst, erscheint hier eine Ampel: <b>grün</b> = wird nur gespeichert, <b>gelb</b> = dokumentieren, <b>rot</b> = Genehmigung nötig. Du siehst also sofort, was passiert.' },
  { sel: '#fAnlagen', title: 'Belege anhängen',
    text: 'Füge Belege bei (Rechnung, Beleg, Mailverkehr). Bei einer Genehmigung werden sie automatisch mitgeschickt.' },
  { sel: '#btnAbsenden', title: 'Melden – fertig',
    text: 'Mit <b>„Zuwendung melden"</b> absenden. Du bekommst sofort eine Rückmeldung und – falls nötig – eine E-Mail zum Genehmigungsstatus.' },
  { sel: '.nav-btn[data-view="meine"]', title: 'Status verfolgen',
    text: 'Unter <b>„Meine Vorgänge"</b> siehst du jederzeit den Stand deiner Meldungen.' },
  { center: true, title: 'Das war’s! 🎉', hilfe: true,
    text: 'Du kannst jetzt loslegen. Eine ausführliche Erklärung – Bewertung, Ablauf, Datenschutz – findest du jederzeit im Reiter <b>Hilfe</b>.' },
];
